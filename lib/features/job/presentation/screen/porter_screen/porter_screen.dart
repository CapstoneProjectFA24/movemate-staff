...
class PorterScreen extends StatefulWidget {
  ...
  @override
  _PorterScreenState createState() => _PorterScreenState();
}
...
class _PorterScreenState extends State<PorterScreen> {
  ...
  Widget build(BuildContext context) {
    final List<BookingJob> jobs = _getJobsForSelectedDate();

    // Sort jobs by start time to display in chronological order
