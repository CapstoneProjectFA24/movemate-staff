...
class _BookingSource implements BookingSource {
  ...
  Future<HttpResponse<SuccessModel>> driverConfirmCashPayment(
    ...
    final _options = _setStreamType<HttpResponse<SuccessModel>>(Options(
      ...
      contentType: contentType,
        ...
        .compose(
          _dio.options,
          '/bookings/confirm-pay-by-cash/${id}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<SuccessModel>> driverUpdateNewService(
    DriverUpdateServiceRequest request,
    String contentType,
    String accessToken,
    int id,
  ) async {
  ...
  Future<HttpResponse<SuccessModel>> porterAcceptIncidentByBookingId(
    PorterAcceptIncidentRequest request,
    String contentType,
    String accessToken,
    int id,
  ) async {
  ...
  Future<HttpResponse<IncidentResponse>> getIncidentListByBookingId(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<IncidentResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late IncidentResponse _value;
    try {
      _value = IncidentResponse.fromMap(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
