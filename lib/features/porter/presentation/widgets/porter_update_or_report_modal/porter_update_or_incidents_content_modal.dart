...
class PorterUpdateOrIncidentsContentModal extends HookConsumerWidget {
  final BookingResponseEntity order;
  final VoidCallback? onClose;
  const PorterUpdateOrIncidentsContentModal({
    super.key,
    required this.order,
    this.onClose,
  });
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    context.router
                        .push(PorterIncidentsScreenRoute(order: order));
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    // Close the modal
                    context.router.push(
                        PorterUpdateNewServiceChildrenScreenRoute(job: order));
