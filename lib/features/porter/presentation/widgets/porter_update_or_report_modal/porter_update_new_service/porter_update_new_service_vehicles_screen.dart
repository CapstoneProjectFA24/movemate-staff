...
@RoutePage()
class PorterUpdateNewServiceVehiclesScreen extends HookConsumerWidget {
  const PorterUpdateNewServiceVehiclesScreen({
    super.key,
    required this.job,
  });
      ...
      bottomNavigationBar: SummarySection(
        ...
        onPlacePress: () async {
          if (bookingState.selectedVehicle != null
            ...
            context.router
                .push(PorterUpdateNewServiceChildrenScreenRoute(job: job));
          } else {
