...
class DeliveryDetailsBottomSheet extends HookConsumerWidget {
  ...
  Widget _buildTrackingInfoCard({
    ...
    String getDriverRole() {
      try {
        ...
        return isResponsible == true ? "chịu tránh nhiệm" : "";
      } catch (e) {
  ...
  Widget _buildDetailsSheet({
    ...
    final bool isResponsible = job.assignments
            .firstWhere(
              (e) => e.isResponsible == true,
            )
            .isResponsible ??
        false;
    // final bool isResponsible = false;
    print('checing $isResponsible');
    return Container(
